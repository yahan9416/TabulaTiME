...
# data_dirs = c("/home1/wangchenfei/Project/TIRA/Data_cancer_latest",
#               "/home1/wangchenfei/Project/TIRA/Data_immunotherapy_latest")
data_dirs = c("/home1/wangchenfei/Project/TIRA/scTumor_Data")
