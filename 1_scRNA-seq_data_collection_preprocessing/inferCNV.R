...
#' @param rowcount_matrix Path of raw count
#' @param InferCNA_geneorder path of inferCNV_gene_order_file.txt
#' @param Cell_annotation alternative parameters, path of cell type annotation
#' @author Ya Han
