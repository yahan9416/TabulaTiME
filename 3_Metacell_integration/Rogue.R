...
#' @param Seurat_obj The path of CCA corrected Seurat object 
#' @author Ya Han
...
#Plot the distribution of Rogue score
library(ggplot2)
...
ggsave(file="Rogue_score_distribution.pdf",p,width = 5,height = 4)
