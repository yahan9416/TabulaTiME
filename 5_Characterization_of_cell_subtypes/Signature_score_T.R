#' Calculate the signature score for each cell type to effectively describe the function of different cell types.
#' In this function, all signarute gene are defined in your dataset.
#' @param SeuratObj_path         The path of Seurat object only including CD8T and NK cells.
