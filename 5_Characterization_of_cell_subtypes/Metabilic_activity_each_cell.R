...
#' @param KEGG_Module_path Information of KEGG_Module_genelist_nameinfo.RData  
#' @param MetaCyc_path Path of MetaCyc_Homo_onlyKeepHS_pathway_gene.RData
#' @param Enzyme_relationship Path of Enzyme_relationship_corr_uni.RData
#' @author Ya Han

args <- commandArgs(trailingOnly = TRUE)
Seurat_obj_path <- args[1]
KEGG_Module_path <-args[2]
MetaCyc_path<-args[3]
Enzyme_relationship<-args[4]
...
######
  ...
  load(KEGG_Module_path)
  load(MetaCyc_path)
  load(Enzyme_relationship)
