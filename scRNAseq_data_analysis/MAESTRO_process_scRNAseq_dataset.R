...
# read data
expr = Read10X_h5("/home/hanya/Oral_cancer/Data/Carcinogenesis_HNSCC_filtered_gene_count.h5")
...
# save object
saveRDS(RNA.res, "Carcinogenesis_HNSCC_res.rds")
