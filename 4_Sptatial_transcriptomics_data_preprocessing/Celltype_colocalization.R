...
DEG_gene_list=readRDS("./Fibroblast_celltype_DEG.rds")
...
DEG_gene_list=readRDS("./Myeloid_celltype_DEG.rds")
DEG_gene_list=droplevels(DEG_gene_list)
DEG_gene_list=DEG_gene_list[ order(DEG_gene_list$avg_log2FC,decreasing = TRUE),]
...
PLC_Myeloid_CTHRC1_cor<<-NULL
  HCCIL_fra #load the deconvolution result rom STRIDE
  Seurat_obj #load the seurat object
